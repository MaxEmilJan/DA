...
(skip this part if the desired version (4.5.x) of opencv was installed with easyocr)
~~~
...
~~~
16. check the path to the tesseract directory an past it into the head of the "text_recognition_cpu.py" file.\
